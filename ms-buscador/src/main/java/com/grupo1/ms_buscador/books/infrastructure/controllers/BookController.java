...
import com.grupo1.ms_buscador.books.application.*;
...
public class BookController {
    ...
    @Operation(summary = "Search books", description = "Search books based on filters", responses = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(description = "List of books", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BookDto.class)))
    })
    @GetMapping()
    ...
    @Operation(summary = "Get a book by Id", description = "Get a book by its Id", responses = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(description = "Book details", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BookDto.class))),
    ...
    @Operation(summary = "Create a book", description = "Create a new book", responses = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(description = "Book Created", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BookDto.class)))
    })
    @PostMapping()
    ...
    @Operation(summary = "Delete a book", description = "Delete a book by its Id", responses = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Book deleted"),
    ...
    @Operation(summary = "Update a book", description = "Update a book by its Id", responses = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(description = "Book updated", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BookDto.class))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "Internal server error")
    })
    @PutMapping("/{id}")
    ...
    @Operation(summary = "Partially update a book", description = "Partially update a book by its Id", responses = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(description = "Book partially updated", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BookDto.class))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "Internal server error")
    })
